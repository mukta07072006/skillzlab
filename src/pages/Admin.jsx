          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex space-x-4">
              <button
                ...
                className={`px-4 py-2 rounded-md font-medium ${activeTab === 'pending' ? 'bg-[#2a74ff] text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Pending
              </button>
              <button
                onClick={() => setActiveTab('stats')}
                className={`px-4 py-2 rounded-md font-medium ${activeTab === 'stats' ? 'bg-[#2a74ff] text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
              >
                Statistics
              </button>
            </div>
                    ...
                    >
                      <div className="p-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                            <CreditCard className="flex-shrink-0 h-4 w-4 text-[#2a74ff] mr-2" />
                            <span>{enroll.payment_method}: {enroll.transaction_id}</span>
                          </div>

                          <div className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                            <Phone className="flex-shrink-0 h-4 w-4 text-[#2a74ff] mr-2" />
                            <span>{enroll.phone || 'No phone provided'}</span>
                          </div>

                          <div className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                            <Hash className="flex-shrink-0 h-4 w-4 text-[#2a74ff] mr-2" />
                            <span>Request ID: {enroll.id}</span>
                          </div>
                        </div>
                        ...
                        <div className="mt-6 flex space-x-3">
                          <motion.button
                            ...
                            className={`flex-1 flex items-center justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${approvingId === enroll.id ? 'bg-yellow-500' : 'bg-[#2a74ff] hover:bg-[#195dc6]'}`}
                          >
