...
function handleViteOverlay(node) {
  ...
  if (backdrop) {
    ...
    const messageText = doc.querySelector('.message-body')?.textContent.trim() || '';
    const fileText = doc.querySelector('.file')?.textContent.trim() || '';
...
console.warn = () => {}; // Suppress Vite warnings
...
export default async () => {
  ...
  // Only load visual editor plugins in development
  if (isDev) {
